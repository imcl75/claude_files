...
```
The session that wrote this transfer doc was called "Enquiry Builder 3". This new session must therefore be named "Enquiry Builder 4" — rename it now before doing anything else.
