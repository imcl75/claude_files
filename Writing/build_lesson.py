...
def build_lo(spec, base_unpacked):
    ...
    lo_xml = replace_ph_text(lo_xml, '10', spec.get('wal', ''))
    lo_xml = replace_ph_text(lo_xml, '13', spec.get('tib', ''))
    lo_xml = replace_ph_text(lo_xml, '14', spec.get('isb', ''))
    return lo_xml, lo_rels
