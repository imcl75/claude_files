LESSON_DATA = { 5: { 'visuals': { 'c1_ido1': { 'title': 'Short multiplication — build up',
                                 ...
                                 'notes': 'I DO C1 — Build from 3-digit. Narrate every step. '
                                          'Demonstrate on the squared paper.'},
                    'c1_ido2': { 'title': '4-digit × 1-digit — step by step',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'multiplication',
                                 'top': '2,364',
                                 'bottom': '3',
                                 ...
                                 'notes': 'I DO C1 — Extend to 4-digit. Pause on hundreds column: '
                                          '3×3+1=10, write 0, regroup 1.'},
                    'c2_ido1': { 'title': 'Multiple regroups — 3,476 × 8',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'multiplication',
                                 'top': '3,476',
                                 'bottom': '8',
                                 ...
                                 'caption': '3,476 × 8\n'
                                            ...
                                            'Work slowly.',
                                 'notes': 'I DO C2 — Multiple regroups every column. Always look '
                                          'for the regroup BEFORE multiplying.'}},
       'wm': { 'items': [17, 8, 34, 6, 25, 12, 41],
               'qa': [ {'q': 'What was the 3rd number?', 'a': '34'},
       ...
       'rm': { 'day': 1,
               'questions': [ { 'num': 1,
                                'topic': 'Place Value',
                                'q': 'Write 40,507 in words.',
                                'a': 'Forty thousand, five hundred and seven'},
                              { 'num': 2,
                                'topic': 'Fractions',
                              ...
                              { 'num': 5,
                                'topic': 'Measurement',
                                'q': 'How many cm in 1.5 m?',
                                'a': '150 cm'}]},
       'vocab': [ ( 'short multiplication',
                    'A formal written method for multiplying a number by a 1-digit number, working '
                    'column by column from ones to the highest place value.'),
                  ('product', 'The answer when two numbers are multiplied together.'),
                  ( 'regroup',
                    'A digit written small above the next column when a column total reaches 10 or '
                    'more.'),
                  ( 'factor',
                    'A number that divides exactly into another. 3 and 4 are both factors of 12.'),
                  ( 'estimate',
                    'A rounded approximation used to check a calculated answer is reasonable.')]},
  6: { 'visuals': { 'c1_ido1': { 'title': 'Short division — the bus stop layout',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'division',
                                 'top': '8,484',
                                 'bottom': '4',
                                 ...
                                 'notes': 'I DO C1 — Stress direction (left to right). Quotient '
                                          'above the bracket. Model checking with multiplication.'},
                    'c1_ido2': { 'title': 'Short division — with a remainder',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'division',
                                 'top': '7,543',
                                 'bottom': '3',
                                 ...
                                 'notes': 'I DO C1 — Show how remainders are regrouped. Final '
                                          'remainder written as "r N".'},
                    'c2_ido1': { 'title': 'What does the remainder mean?',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'division',
                                 'top': '9,157',
                                 'bottom': '6',
                                 ...
                                 'caption': '9,157 ÷ 6\n'
                                            ...
                                            '\n'
                                            'The remainder = sweets left over — cannot be shared '
                                            'equally.',
                                 'notes': 'I DO C2 — Interpret the remainder in context. Ask: does '
                                          'the remainder mean we round up or down?'}},
       'wm': { 'items': ['castle', 'multiply', 'penguin', 'divide', 'trophy', 'whisper', 'balance'],
               'qa': [ {'q': 'What was the 2nd word?', 'a': 'multiply'},
       ...
       'rm': { 'day': 2,
               'questions': [ { 'num': 1,
                                'topic': 'Place Value',
                                'q': 'Round 37,846 to the nearest thousand.',
                                'a': '38,000'},
                              { 'num': 2,
                                'topic': 'Fractions',
                                'q': 'What is 0.6 as a fraction?',
                                'a': '3/5'},
                              ...
                              { 'num': 5,
                                'topic': 'Measurement',
                                'q': 'How many ml in 2.5 litres?',
                                'a': '2,500 ml'}]},
       'vocab': [ ( 'short division',
                    'A formal written method for dividing a number by a 1-digit number using the '
                    'bus stop layout, working left to right.'),
                  ...
                  ( 'remainder',
                    'The amount left over when a number does not divide exactly. 25 ÷ 4 = 6 '
                    'remainder 1.')]},
  7: { 'visuals': { 'c1_ido1': { 'title': 'Choose your method — multiplication',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'multiplication',
                                 'top': '1,234',
                                 'bottom': '6',
                                 ...
                                 'caption': '1,234 × 6\n'
                                            ...
                                            'How many in 6 boxes?',
                                 'notes': 'I DO C1 — Model full process: underline key words, '
                                          'estimate, calculate, check vs estimate.'},
                    'c1_ido2': { 'title': 'Two-step multiplication — find the hidden step',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'multiplication',
                                 'top': '1,256',
                                 'bottom': '3',
                                 ...
                                 'caption': 'Step 1: 1,256 × 3 = blue pens\n'
                                            ...
                                            'How many altogether?',
                                 'notes': 'I DO C1 I2 — Two-step. Slide shows Step 1. Narrate Step '
                                          '2 verbally and on the squared paper.'},
                    'c2_ido1': { 'title': 'Two-step — plan before you calculate',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'multiplication',
                                 'top': '2,135',
                                 'bottom': '4',
                                 ...
                                 'notes': 'I DO C2 — Model planning both steps (× then −). Ask '
                                          'pupils to predict the second operation.'}},
       'wm': { 'items': ['🚀', '🌊', '🎯', '🦁', '🍎', '🔑', '⭐'],
               'qa': [ {'q': 'What was the 3rd emoji?', 'a': '🎯'},
       ...
       'rm': { 'day': 3,
               'questions': [ { 'num': 1,
                                'topic': 'Place Value',
                                'q': 'What is the value of 7 in 47,362?',
                                'a': '7,000'},
                              { 'num': 2,
                                'topic': 'Fractions',
                                'q': 'Order from smallest: 0.5, 3/4, 0.25',
                                'a': '0.25, 0.5, 3/4'},
                              { 'num': 3,
                                'topic': 'Multiplication',
                                'q': 'What is 8 × 12?',
                              ...
                              { 'num': 4,
                                'topic': 'Geometry',
                                'q': 'Area of a rectangle 6 cm × 9 cm?',
                                'a': '54 cm²'},
                              { 'num': 5,
                                'topic': 'Measurement',
                                'q': 'How many minutes in 2.5 hours?',
                                'a': '150 minutes'}]},
       'vocab': [ ('multiply', 'To find the total of equal groups. 4 × 6 = 24.'),
                  ('multiple', 'A number in a times table. 24 is a multiple of both 6 and 4.'),
                  ( 'efficient',
                    'Using the quickest or most straightforward method to get the right answer.'),
                  ( 'approximate',
                    'A value close to the exact answer, often found by rounding first.'),
                  ( 'two-step problem',
                    'A problem that needs two separate calculations to reach the final answer.')]},
  8: { 'visuals': { 'c1_ido1': { 'title': 'Mixed × and ÷ — divide first',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'division',
                                 'top': '5,640',
                                 'bottom': '8',
                                 ...
                                 'notes': 'I DO C1 — Model a ÷ then − two-step. Stress: identify '
                                          'what you find first before calculating.'},
                    'c1_ido2': { 'title': 'Multiply then subtract',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'multiplication',
                                 'top': '1,425',
                                 'bottom': '6',
                                 ...
                                 'notes': 'I DO C1 I2 — Draw a bar model on the board first. '
                                          'Pupils sketch bar model in LP.'},
                    'c2_ido1': { 'title': 'Work backwards — how large is each team?',
                                 'slide_type': 'column_calc',
                                 'calc_type': 'division',
                                 'top': '4,250',
                                 'bottom': '5',
                                 ...
                                 'notes': 'I DO C2 — Work backwards problem. Find teams first, '
                                          'then size. Model on squared paper.'}},
       'wm': { 'items': [ 'The 🚀 travels at great speed.',
               ...
               'qa': [ {'q': 'What did she find under the mat?', 'a': 'A key 🔑'},
       ...
       'rm': { 'day': 4,
               'questions': [ { 'num': 1,
                              ...
                              { 'num': 5,
                                'topic': 'Measurement',
                                'q': 'A jug holds 2 litres. How many 250 ml cups can it fill?',
                                'a': '8 cups'}]},
       'vocab': [ ('divide', 'To split a number into equal groups. 24 ÷ 6 = 4.'),
                  ('quotient', 'The result of a division.'),
                  ( 'bar model',
                    'A diagram using rectangles to represent quantities and relationships in a '
                    'problem.'),
                  ( 'reasoning',
                    'Explaining why an answer is correct using evidence from the calculation or '
                    'context.'),
                  ( 'justify',
                    'To provide mathematical argument that proves an answer is correct.')]},
  9: { 'visuals': { 'c1_ido1': { 'slide_type': 'word_problem',
                                 'title': 'Visualise, analyse, attack',
                                 'problem': 'There are 6 bags.\n'
                                            'Each bag holds 4 oranges.\n'
                                            'How many oranges altogether?',
                                 'i_know': '6 bags (groups) · 4 oranges in each bag (group size)',
                                 'finding': 'the total number of oranges',
                                 'attack': 'I know the groups AND the group size  →  ×',
                                 'notes': 'I DO C1 — Model Visualise→Analyse→Attack. "I can '
                                          'picture 6 bags with 4 oranges in each. I know the '
                                          'number of groups AND the group size, so I multiply."'},
                    'c1_ido2': { 'slide_type': 'word_problem',
                                 'title': 'Visualise, analyse, attack',
                                 'problem': '30 stickers shared equally\n'
                                            'between 5 friends.\n'
                                            'How many does each friend get?',
                                 'i_know': '30 stickers in total · 5 friends sharing them',
                                 'finding': 'how many each friend gets (the group size)',
                                 'attack': 'I know the total AND the number of groups  →  ÷',
                                 'notes': 'I DO C1 I2 — Visualise: 30 stickers being dealt out '
                                          'between 5 friends. Total and number of groups are '
                                          'known. Group size is unknown → divide.'},
                    'c2_ido1': { 'slide_type': 'word_problem',
                                 'title': 'Reason from structure',
                                 'problem': '48 eggs packed into boxes.\n'
                                            'Each box holds 6 eggs.\n'
                                            'How many boxes are needed?',
                                 'i_know': '48 eggs in total · 6 eggs in each box (group size)',
                                 'finding': 'the number of boxes (number of groups)',
                                 'attack': 'I know the total AND the group size  →  ÷',
                                 'notes': 'I DO C2 — Visualise: 48 eggs being put 6 at a time into '
                                          'boxes. Total and group size are known. Number of groups '
                                          'unknown → divide.'},
                    'c2_ido2': { 'slide_type': 'stm_word_problem',
                                 'title': 'Spot the mistake',
                                 'problem': 'There are 5 bags with 8 toys in each bag.\n'
                                            'How many toys altogether?',
                                 'wrong_working': '5 + 8 = 13 toys',
                                 'error': 'Visualise: 5 bags, 8 toys in each.\n'
                                          'Analyse: I know 5 groups · 8 in each group.\n'
                                          'Attack: groups AND group size known → × not +',
                                 'notes': 'STM — Wrong operation. Use the routine to show why: '
                                          'visualise 5 bags of 8 → I know groups and group size → '
                                          'I must multiply.'}},
       'wm': { 'items': [8, 24, 56, 12, 48, 36, 64],
               'qa': [ {'q': 'What was the 3rd number?', 'a': '56'},
       ...
       'rm': { 'day': 1,
               'questions': [ { 'num': 1,
                                'topic': 'Place Value',
                                'q': 'What is the value of 4 in 84,362?',
                                'a': '4,000'},
                              { 'num': 2,
                                'topic': 'Fractions',
                                'q': 'What is 1/4 of 48?',
                              ...
                              { 'num': 5,
                                ...
                                'q': 'How many cm in 1.5 m?',
                                'a': '150 cm'}]},
       'vocab': [ ['operation', 'A mathematical process: add, subtract, multiply or divide.'],
                  ...
                  [ 'share equally',
                    'Splitting into equal parts — a signal that division is needed.'],
                  ['altogether', 'All amounts combined — a signal that addition is needed.']]},
  10: { 'visuals': { 'c1_ido1': { 'slide_type': 'identify_calculate',
                                  'title': 'Visualise, analyse, attack — then calculate',
                                  'problem': 'A class has 6 tables.\n'
                                             'Each table has 4 chairs.\n'
                                             'How many chairs altogether?',
                                  'i_know': '6 tables (groups) · 4 chairs at each table (group '
                                            'size)',
                                  'finding': 'the total number of chairs',
                                  'attack': 'I know the groups AND the group size  →  ×',
                                  'calc_method': 'mental',
                                  'calculation': '6 × 4 = 24',
                                  'answer': '24 chairs',
                                  'notes': 'I DO C1 — Visualise 6 tables with 4 chairs at each. '
                                           'Groups and group size known → multiply. Then '
                                           'calculate.'},
                     'c1_ido2': { 'slide_type': 'identify_calculate',
                                  'title': 'Visualise and reason — then calculate',
                                  'problem': '84 stickers shared equally\n'
                                             'between 6 friends.\n'
                                             'How many does each friend get?',
                                  'i_know': '84 stickers in total · 6 friends (groups)',
                                  'finding': 'how many each friend gets (group size)',
                                  'attack': 'I know the total AND the number of groups  →  ÷',
                                  'calc_method': 'short_division',
                                  'top': '84',
                                  'bottom': '6',
                                  'answer': '14 stickers each',
                                  'notes': 'I DO C1 I2 — Visualise 84 stickers split into 6 equal '
                                           'piles. Total and groups known → divide. Use short '
                                           'division.'},
                     'c2_ido1': { 'slide_type': 'identify_calculate',
                                  'title': 'Addition and subtraction',
                                  'problem': 'There are 264 red beads and 153 blue beads.\n'
                                             'How many beads are there altogether?',
                                  'i_know': '264 red beads · 153 blue beads (two separate amounts)',
                                  'finding': 'the total number of beads',
                                  'attack': 'I need to combine two amounts  →  +',
                                  'calc_method': 'column_addition',
                                  'top': '264',
                                  'bottom': '153',
                                  'answer': '417 beads',
                                  'notes': 'I DO C2 — Visualise two piles of beads being joined. '
                                           'Combining two amounts → add. Use column addition.'},
                     'c2_ido2': { 'slide_type': 'stm_word_problem',
                                  'title': 'Spot the mistake',
                                  'problem': '84 stickers shared equally between 6 friends.\n'
                                             'How many does each friend get?',
                                  'wrong_working': '84 × 6 = 504',
                                  'error': 'Visualise: 84 stickers dealt into 6 equal piles.\n'
                                           'Analyse: I know the total (84) and the groups (6).\n'
                                           'Attack: total AND groups known → ÷ not ×',
                                  'notes': 'STM — Wrong operation. The routine catches this: '
                                           'visualise → analyse → 84 total, 6 groups → divide.'}},
        'wm': { 'items': ['share', 'multiply', 'total', 'groups', 'equal', 'divide', 'steps'],
                'qa': [ {'q': 'What was the 3rd word?', 'a': 'total'},
        ...
        'rm': { 'day': 2,
                'questions': [ { 'num': 1,
                                 'topic': 'Place Value',
                                 'q': 'Round 7,841 to the nearest 1,000',
                                 'a': '8,000'},
                               { 'num': 2,
                                 'topic': 'Fractions',
                               ...
                               { 'num': 4,
                                 'topic': 'Geometry',
                                 'q': 'Perimeter of a square with sides 8 cm?',
                                 'a': '32 cm'},
                               { 'num': 5,
                                 'topic': 'Measurement',
                                 'q': 'How many ml in 3.5 litres?',
                                 'a': '3,500 ml'}]},
        'vocab': [ ['identify', 'To name or recognise which operation a problem needs.'],
                   ['estimate', 'A sensible approximation before calculating.'],
                   [ 'regroup',
                     'To exchange 10 ones for 1 ten (or 10 tens for 1 hundred) during a '
                     'calculation.'],
                   ['two-step routine', 'Step 1: identify the operation. Step 2: calculate.'],
                   [ 'short multiplication',
                     'A compact written method for multiplying by a 1-digit number.']]},
  11: { 'visuals': { 'c1_ido1': { 'slide_type': 'bar_model',
                                  'title': 'Plan two steps',
                                  'problem': 'There are 5 bags of crayons.\n'
                                             'Each bag holds 8 crayons.\n'
                                             '4 crayons break.\n'
                                             'How many good crayons are there?',
                                  'step1': { 'label': '5 × 8',
                                             'op': '×',
                                             'a': '5',
                                             'b': '8',
                                  ...
                                  'notes': 'I DO C1 — Visualise first: bags of crayons, then some '
                                           'break. Bar model to plan both steps.'},
                     'c1_ido2': { 'slide_type': 'bar_model',
                                  'title': 'Label before you calculate',
                                  'problem': 'A baker bakes 96 biscuits.\n'
                                             'She packs them into boxes of 6.\n'
                                             'She gives away 8 boxes.\n'
                                             'How many boxes does she have left?',
                                  'step1': { 'label': '96 ÷ 6',
                                             'op': '÷',
                                             'a': '96',
                                             'b': '6',
                                  ...
                                  'step2': { 'label': '16 − 8',
                                             ...
                                             'calculation': '16 − 8 = 8'},
                                  'answer': '8 boxes left',
                                  'notes': 'I DO C1 I2 — Two steps. Step 1: total and group size '
                                           'known → divide. Step 2: mental subtraction.'},
                     'c2_ido1': { 'slide_type': 'bar_model',
                                  'title': 'Does the order matter?',
                                  'problem': 'Jake has 3 boxes of books.\n'
                                             'Each box has 8 books.\n'
                                             'He is given 15 more books.\n'
                                  ...
                                  'step2': { 'label': '24 + 15',
                                             ...
                                             'result': '39',
                                             'calc_method': 'mental',
                                             'calculation': '24 + 15 = 39'},
                                  'answer': '39 books',
                                  'notes': 'I DO C2 — Step 1 must come first: find total in boxes '
                                           'before adding extra books.'},
                     'c2_ido2': { 'slide_type': 'stm_word_problem',
                                  'title': 'Spot the mistake',
                                  'problem': 'There are 5 bags with 8 apples each.\n'
                                             'A baker uses 12 apples. How many are left?',
                                  'wrong_working': 'Step 1: 8 − 12 = cannot do this\n'
                                                   'Step 2: × 5 = ???',
                                  'error': 'Plan with a bar model first.\n'
                                           'Step 1: 5 × 8 = 40\n'
                                           'Step 2: 40 − 12 = 28',
                                  'notes': 'STM — Steps in wrong order. Bar model planning '
                                           'prevents this error.'}},
        'wm': { 'items': ['🌟', '🎯', '🦋', '🍕', '🎪', '🦁', '🌈'],
                'qa': [ {'q': 'What was the 3rd emoji?', 'a': '🦋'},
                        {'q': 'What was the first emoji?', 'a': '🌟'},
        ...
        'rm': { 'day': 3,
                'questions': [ { 'num': 1,
                                 'topic': 'Place Value',
                                 'q': 'Write 30,500 in words',
                                 'a': 'thirty thousand five hundred'},
                               { 'num': 2,
                                 'topic': 'Fractions',
                                 'q': 'What is 3/5 of 40?',
                                 'a': '24'},
                               ...
                               { 'num': 5,
                                 'topic': 'Measurement',
                                 'q': 'How many grams in 2.25 kg?',
                                 'a': '2,250 g'}]},
        'vocab': [ [ 'two-step',
                     'A problem that needs two separate calculations to find the answer.'],
  ...
  12: { 'visuals': { 'c1_ido1': { 'slide_type': 'identify_calculate',
                                  'title': 'Money: visualise and reason',
                                  'problem': 'Pencils cost 15p each.\n'
                                             'I buy 6 pencils.\n'
                                             'How much do I spend?',
                                  'i_know': '6 pencils (groups) · 15p for each pencil (group size)',
                                  'finding': 'the total cost',
                                  'attack': 'I know the groups AND the group size  →  ×',
                                  'calc_method': 'mental',
                                  'calculation': '15 × 6 = 90',
                                  'answer': '90p',
                                  'notes': 'I DO C1 — Mental. Answer is 90p. Visualise 6 pencils '
                                           'at 15p each.'},
                     'c1_ido2': { 'slide_type': 'identify_calculate',
                                  'title': 'Written method — money',
                                  'problem': 'A notebook costs 35p.\n'
                                             'I buy 8 notebooks.\n'
                                             'How much do I spend?',
                                  'i_know': '8 notebooks (groups) · 35p each (group size)',
                                  'finding': 'the total cost',
                                  'attack': 'I know the groups AND the group size  →  ×',
                                  'calc_method': 'compact_column',
                                  'top': '35',
                                  'bottom': '8',
                                  'answer': '280p = £2.80',
                                  'notes': 'I DO C1 I2 — Compact column. Convert 280p = £2.80. '
                                           'Include unit.'},
                     'c2_ido1': { 'slide_type': 'identify_calculate',
                                  'title': 'Measurement: visualise and reason',
                                  'problem': 'A piece of ribbon is 156 cm long.\n'
                                             'It is cut into 6 equal pieces.\n'
                                             'How long is each piece?',
                                  'i_know': '156 cm in total · 6 equal pieces (number of groups)',
                                  'finding': 'the length of each piece (group size)',
                                  'attack': 'I know the total AND the number of groups  →  ÷',
                                  'calc_method': 'short_division',
                                  'top': '156',
                                  'bottom': '6',
                                  'answer': '26 cm',
                                  'notes': 'I DO C2 — Short division. Answer must include cm.'},
                     'c2_ido2': { 'slide_type': 'stm_word_problem',
                                  'title': 'Spot the mistake',
                                  'problem': 'A piece of ribbon is 156 cm long.\n'
                                             'Cut into 6 equal pieces.\n'
                                             'How long is each piece?',
                                  'wrong_working': '156 ÷ 6 = 26 kg',
                                  'error': 'The calculation is correct.\n'
                                           'But the unit is wrong — the answer must be 26 cm.',
                                  'notes': 'STM — Right arithmetic, wrong unit. Every measurement '
                                           'answer needs the correct unit.'}},
        'wm': { 'items': [ 'The 🌟 shone in the dark sky.',
                ...
                'qa': [ {'q': 'What shone in the dark sky?', 'a': 'A star 🌟'},
                        ...
                        { 'q': 'What sentence mentioned the big top?',
                          'a': 'The 🎪 opened on a hot day.'}]},
        'rm': { 'day': 4,
                'questions': [ { 'num': 1,
                                 'topic': 'Place Value',
                                 'q': 'What is 100 × 349?',
                               ...
                               { 'num': 2,
                                 'topic': 'Fractions',
                                 'q': 'Order from largest: 1/2, 3/8, 5/6',
                                 'a': '5/6, 1/2, 3/8'},
                               {'num': 3, 'topic': 'Division', 'q': '108 ÷ 9 = ?', 'a': '12'},
                               { 'num': 4,
                                 'topic': 'Geometry',
                                 'q': 'Area of a rectangle 7 cm × 8 cm?',
                                 'a': '56 cm²'},
                               { 'num': 5,
                                 'topic': 'Measurement',
                                 'q': 'How many minutes in 3/4 of an hour?',
                                 'a': '45 minutes'}]},
        'vocab': [ ['pence', 'The smaller unit of British money. 100 pence = £1.'],
...
LESSON_DATA[13] = {
    'visuals': {
        ...
        'questions': [ {'q': 'What was the 3rd number?', 'a': '34'},
                       {'q': 'What was the last number?', 'a': '41'},
                       {'q': 'Which number was the largest?', 'a': '41'},
                       {'q': 'What were the first two numbers?', 'a': '17 and 8'},
                       {'q': 'What was the 5th number?', 'a': '25'}]},
...
LESSON_DATA[20] = {
    ...
    'wm': {
        ...
        'qa': [
            ...
            {'q': 'Which number was smallest?',        'a': '16'},
    ...
    'rm': {
        'day': 1,
        'questions': [
            {'num': 1, 'topic': 'Place Value',
             'q': 'What is 1,000 more than 8,743?', 'a': '9,743'},
            {'num': 2, 'topic': 'Addition and Subtraction',
             'q': 'Calculate 6,483 + 2,759.', 'a': '9,242'},
            {'num': 3, 'topic': 'Fractions',
             'q': 'What is 3/4 of 48?', 'a': '36'},
            {'num': 4, 'topic': 'Measurement',
             'q': 'How many grams are in 2.5 kg?', 'a': '2,500 g'},
            {'num': 5, 'topic': 'Addition and Subtraction',
             'q': 'Calculate 8,000 \u2212 3,467.', 'a': '4,533'},
        ],
    },
}
...
LESSON_DATA[21] = {
    ...
    'rm': {
        ...
        'questions': [
            {'num': 1, 'topic': 'Place Value',
             'q': 'Write 4,060 in words.', 'a': 'four thousand and sixty'},
            {'num': 2, 'topic': 'Fractions',
             'q': 'Write two equivalent fractions for 1/2.',
             'a': '2/4 and 4/8 (or any equivalent pair)'},
            {'num': 3, 'topic': 'Addition and Subtraction',
             'q': 'Calculate 7,254 \u2212 3,816.', 'a': '3,438'},
            {'num': 4, 'topic': 'Measurement',
             'q': 'A jug holds 1.5 litres.\nHow many ml is this?', 'a': '1,500 ml'},
            {'num': 5, 'topic': 'Place Value',
             'q': 'What is the value of the digit 7 in 7,324?',
             'a': '7,000 (7 thousands)'},
        ],
    },
}
...
LESSON_DATA[22] = {
    'visuals': {
        ...
        'c2_ido1': {
            ...
            'chart_data': {
                ...
                'col_headers': ['Season', 'Bristol (hours)', 'S\u00e3o Paulo (hours)'],
                'rows': [
                    ['Winter',  8,  11],
                    ['Spring',  12, 12],
                    ['Summer',  17, 11],
    ...
    'wm': {
        'items': [
            'The \U0001f321\ufe0f showed it was 24 degrees outside.',
            'She counted \U0001f98b butterflies on each flower.',
            'He carried a \U0001f9f3 weighing 4 kilograms.',
            'They spotted \U0001f6a2 ships sailing past the harbour.',
            'A \U0001f327\ufe0f shower arrived and everyone got wet.',
            'The \U0001f98a ran quickly across the field.',
            'The \U0001f3d6\ufe0f was busy with summer visitors.',
        ],
        'qa': [
            {'q': 'What did the thermometer show?',       'a': '24 degrees \U0001f321\ufe0f'},
            {'q': 'What was she counting on the flowers?','a': 'Butterflies \U0001f98b'},
            {'q': 'How heavy was the box?',               'a': '4 kilograms \U0001f9f3'},
            {'q': 'What arrived and made everyone wet?',  'a': 'A shower \U0001f327\ufe0f'},
            {'q': 'What ran across the field?',           'a': 'A fox \U0001f98a'},
        ],
    },
    'vocab': [
        ['claim',    'A statement that may or may not be true \u2014 you must use data to check it.'],
        ['evaluate', 'To decide whether a statement is true or false, using evidence from data.'],
        ['evidence', 'Specific values from a chart or table that support or disprove a claim.'],
    ],
    'rm': {
        'day': 4,
        'questions': [
            {'num': 1, 'topic': 'Place Value',
             'q': 'Round 7,856 to the nearest 1,000.', 'a': '8,000'},
            {'num': 2, 'topic': 'Addition and Subtraction',
             'q': 'Calculate 5,372 + 4,938.', 'a': '10,310'},
            {'num': 3, 'topic': 'Fractions',
             'q': 'Which is larger \u2014 5/8 or 1/2?\nExplain.', 'a': '5/8  (5/8 > 4/8)'},
            {'num': 4, 'topic': 'Measurement',
             'q': 'A shelf is 2 m 35 cm long.\nHow many cm is this?', 'a': '235 cm'},
            {'num': 5, 'topic': 'Fractions',
             'q': 'What is 2/5 of 60?', 'a': '24'},
        ],
    },
}
...
LESSON_DATA[23] = {
    ...
    'wm': {
        ...
        'qa': [
            ...
            {'q': 'Which number was largest?',        'a': '93'},
    ...
    'rm': {
        ...
        'questions': [
            {'num': 1, 'topic': 'Place Value',
             'q': 'Order greatest first:\n3,099  3,909  3,990  3,009',
             'a': '3,990  \u2003  3,909  \u2003  3,099  \u2003  3,009'},
            {'num': 2, 'topic': 'Fractions',
             'q': 'What fraction of 1 hour is 15 minutes?', 'a': '1/4'},
            {'num': 3, 'topic': 'Addition and Subtraction',
             'q': 'Calculate 9,423 \u2212 6,285.', 'a': '3,138'},
            {'num': 4, 'topic': 'Measurement',
             'q': 'A recipe uses 750 ml from a 1-litre carton.\nHow much is left?', 'a': '250 ml'},
            {'num': 5, 'topic': 'Place Value',
             'q': 'What is 100 more than 9,905?', 'a': '10,005'},
        ],
    },
}

# ─── T6W7 — End-of-year consolidation: four operations ────────────────────────

LESSON_DATA[24] = {
    'visuals': {
        # ── CYCLE 1: Column addition ──────────────────────────────────────────
        'c1_ido1': {
            'slide_type': 'identify_calculate',
            'title': 'I Do — addition',
            'problem': 'A school has 2,648 fiction books and\n1,735 non-fiction books.\nHow many books does it have altogether?',
            'i_know': 'fiction = 2,648  ·  non-fiction = 1,735',
            'finding': 'total number of books',
            'attack': '"Altogether" → ADD the two amounts.',
            'calc_method': 'column_addition',
            'top':    '2648',
            'bottom': '1735',
            'answer': '4,383 books altogether',
            'notes': 'I DO C1 — model setting up column addition, aligning digits. Emphasise "altogether" = add.',
        },
        'c1_ido2': {
            'slide_type': 'stm_word_problem',
            'title': 'Spot the mistake',
            'problem': 'A baker baked 3,456 biscuits in the morning\nand 1,287 more in the afternoon.\nA pupil wrote: 3,456 − 1,287 = 2,169 biscuits altogether.',
            'wrong_working': '3,456 − 1,287 = 2,169 biscuits',
            'error': 'Visualise: baker bakes twice — total grows.\nAnalyse: morning=3,456, afternoon=1,287 more.\nAttack: "more"/"altogether" → ADD. Correct: 3,456+1,287=4,743.',
            'notes': 'STM C1 — pupils spot that subtraction was used instead of addition.',
        },
        'c1_wedo': {
            'slide_type': 'identify_calculate',
            'title': 'We Do — together',
            'problem': 'A sports club has 3,172 members.\nThey sign up 1,856 new members.\nHow many members are there now?',
            'i_know': 'existing = 3,172  ·  new = 1,856',
            'finding': 'total members',
            'attack': '"Sign up" and "now" → ADD the amounts.',
            'calc_method': 'column_addition',
            'top':    '3172',
            'bottom': '1856',
            'answer': '5,028 members now',
            'notes': 'WE DO C1 — pupils call out each step as teacher works the column method on the board.',
        },
        # ── CYCLE 2: Column subtraction ───────────────────────────────────────
        'c2_ido1': {
            'slide_type': 'identify_calculate',
            'title': 'I Do — subtraction',
            'problem': 'A warehouse had 7,203 items in stock.\nShops ordered 3,456 items.\nHow many items were left in the warehouse?',
            'i_know': 'start = 7,203  ·  ordered = 3,456',
            'finding': 'items remaining',
            'attack': '"Left" → SUBTRACT the amount taken.',
            'calc_method': 'column_subtraction',
            'top':    '7203',
            'bottom': '3456',
            'answer': '3,747 items left',
            'notes': 'I DO C2 — model column subtraction, regrouping across zeros.',
        },
        'c2_ido2': {
            'slide_type': 'stm_word_problem',
            'title': 'Spot the mistake',
            'problem': 'There were 5,000 people at a festival.\n1,843 went home early.\nA pupil wrote: 5,000 + 1,843 = 6,843 people left.',
            'wrong_working': '5,000 + 1,843 = 6,843 people left',
            'error': 'Visualise: crowd shrinks as people leave.\nAnalyse: start=5,000, left=1,843.\nAttack: "went home" → crowd DECREASES. Subtract: 5,000−1,843=3,157.',
            'notes': 'STM C2 — pupils spot that addition was used instead of subtraction.',
        },
        'c2_wedo': {
            'slide_type': 'identify_calculate',
            'title': 'We Do — together',
            'problem': 'A school raised £6,050 for charity.\nThey spent £2,387 on new equipment.\nHow much money was left?',
            'i_know': 'raised = £6,050  ·  spent = £2,387',
            'finding': 'money remaining',
            'attack': '"Spent" and "left" → SUBTRACT.',
            'calc_method': 'column_subtraction',
            'top':    '6050',
            'bottom': '2387',
            'answer': '£3,663 left',
            'notes': 'WE DO C2 — pupils support each step. Highlight regrouping from the thousands.',
        },
    },
    'wm': {
        'items': [1247, 3905, 6482, 2071, 8534, 4316, 7263],
        'category': 'numbers',
        'qa': [
            {'q': 'What was the 3rd number?',          'a': '6,482'},
            {'q': 'Which number is smallest?',          'a': '1,247'},
            {'q': 'What was the 5th number?',           'a': '8,534'},
            {'q': 'Which two numbers are both over 7,000?', 'a': '8,534 and 7,263'},
            {'q': 'What were the last two numbers?',    'a': '4,316 and 7,263'},
        ],
        'questions': [
            {'q': 'What was the 3rd number?',          'a': '6,482'},
            {'q': 'Which number is smallest?',          'a': '1,247'},
    ...
    'vocab': [
        ['sum',           'The total you get when you add numbers together.'],
        ['difference',    'The answer when you subtract one number from another.'],
        ['regroup',       'To exchange a unit from one column for ten of the column to the right when adding or subtracting.'],
        ['estimate',      'A rough calculation to check whether your answer is reasonable.'],
        ['inverse',       'The opposite operation — addition is the inverse of subtraction.'],
    ],
    'rm': {
        'day': 1,
        'questions': [
            {'num': 1, 'topic': 'Place Value',
             'q': 'What is 1,000 more than 6,842?', 'a': '7,842'},
            {'num': 2, 'topic': 'Addition and Subtraction',
             'q': 'Calculate 4,376 + 2,958.', 'a': '7,334'},
            {'num': 3, 'topic': 'Fractions',
             'q': 'What is 3/4 of 60?', 'a': '45'},
            {'num': 4, 'topic': 'Measurement',
             'q': 'How many cm in 4.5 m?', 'a': '450 cm'},
            {'num': 5, 'topic': 'Addition and Subtraction',
             'q': 'Calculate 8,003 − 2,748.', 'a': '5,255'},
        ],
    },
}
...
LESSON_DATA[25] = {
    'visuals': {
        # ── CYCLE 1: 3-digit × 1-digit ───────────────────────────────────────
        'c1_ido1': {
            'slide_type': 'identify_calculate',
            'title': 'I Do — multiplication',
            'problem': 'A factory makes 324 chairs each day.\nHow many chairs does it make in 6 days?',
            'i_know': 'per day = 324  ·  days = 6',
            'finding': 'total chairs made',
            'attack': '"Each day for 6 days" means equal groups → MULTIPLY.',
            'calc_method': 'compact_column',
            'top':    '324',
            'bottom': '6',
            'answer': '1,944 chairs',
            'notes': 'I DO C1 — model compact column multiplication. Highlight regrouping into the tens column.',
        },
        'c1_ido2': {
            'slide_type': 'stm_word_problem',
            'title': 'Spot the mistake',
            'problem': 'A lorry carries 258 boxes on each trip.\nIt makes 7 trips.\nA pupil wrote: 258 + 7 = 265 boxes in total.',
            'wrong_working': '258 + 7 = 265 boxes',
            'error': 'Visualise: 7 lorry trips, 258 boxes each.\nAnalyse: groups=7, per group=258.\nAttack: equal groups → MULTIPLY. 258×7=1,806, not 258+7.',
            'notes': 'STM C1 — pupils identify that addition was used instead of multiplication for equal groups.',
        },
        'c1_wedo': {
            'slide_type': 'identify_calculate',
            'title': 'We Do — together',
            'problem': 'A school orders 136 pencils for each of its 8 classes.\nHow many pencils does it order altogether?',
            'i_know': 'per class = 136  ·  classes = 8',
            'finding': 'total pencils',
            'attack': '"Each of 8 classes" means equal groups → MULTIPLY.',
            'calc_method': 'compact_column',
            'top':    '136',
            'bottom': '8',
            'answer': '1,088 pencils',
            'notes': 'WE DO C1 — pupils work through each multiplication step with teacher.',
        },
        # ── CYCLE 2: 4-digit × 1-digit ───────────────────────────────────────
        'c2_ido1': {
            'slide_type': 'identify_calculate',
            'title': 'I Do — larger multiplication',
            'problem': 'A cinema has 1,248 seats.\nIt runs 4 full showings every day.\nHow many tickets could it sell each day?',
            'i_know': 'seats per showing = 1,248  ·  showings = 4',
            'finding': 'total tickets per day',
            'attack': '4 equal showings → MULTIPLY.',
            'calc_method': 'compact_column',
            'top':    '1248',
            'bottom': '4',
            'answer': '4,992 tickets',
            'notes': 'I DO C2 — model 4-digit × 1-digit compact column. Emphasise place-value alignment.',
        },
        'c2_ido2': {
            'slide_type': 'stm_word_problem',
            'title': 'Spot the mistake',
            'problem': 'A stadium has 2,136 seats in each section.\nThere are 5 sections.\nA pupil wrote: 2,136 × 5 = 11,680 seats.',
            'wrong_working': '2,136 × 5 = 11,680 seats',
            'error': 'Visualise: 5 equal sections of 2,136 seats.\nAnalyse: per section=2,136, sections=5.\nAttack: Ones error — 6×5=30 not 40. Correct: 2,136×5=10,680.',
            'notes': 'STM C2 — pupils spot a calculation error in the ones column. Stress the need to estimate first (2,000 × 5 = 10,000) to catch errors.',
        },
        'c2_wedo': {
            'slide_type': 'identify_calculate',
            'title': 'We Do — together',
            'problem': 'A baker makes 1,345 loaves each week.\nHow many loaves does she make in 6 weeks?',
            'i_know': 'per week = 1,345  ·  weeks = 6',
            'finding': 'total loaves',
            'attack': '6 equal weeks → MULTIPLY.',
            'calc_method': 'compact_column',
            'top':    '1345',
            'bottom': '6',
            'answer': '8,070 loaves',
            'notes': 'WE DO C2 — pupils call out digits as teacher calculates. Note zero in the tens of the answer.',
        },
    },
    'wm': {
        'items': ['multiply', 'product', 'groups', 'factor', 'twice', 'times', 'efficient'],
        'category': 'words',
        'qa': [
            {'q': 'What was the 3rd word?',                         'a': 'groups'},
            {'q': 'Which word means the result of multiplying?',    'a': 'product'},
            {'q': 'What was the 5th word?',                         'a': 'twice'},
            {'q': 'What were the last two words?',                  'a': 'times and efficient'},
            {'q': 'What was the 1st word?',                         'a': 'multiply'},
        ],
        'questions': [
            {'q': 'What was the 3rd word?',                         'a': 'groups'},
            {'q': 'Which word means the result of multiplying?',    'a': 'product'},
    ...
    'vocab': [
        ...
        ['factor',         'A number that divides exactly into another — e.g. 3 is a factor of 12.'],
        ['efficient',      'Choosing the quickest and clearest method to get the right answer.'],
        ['estimate',       'A rounded calculation to check whether your answer is reasonable.'],
        ['compact method', 'A written multiplication method where regrouped values are noted above the calculation.'],
    ],
    'rm': {
        'day': 2,
        'questions': [
            {'num': 1, 'topic': 'Place Value',
             'q': 'What is the value of the 4 in 34,726?', 'a': '4,000'},
            {'num': 2, 'topic': 'Multiplication',
             'q': 'Calculate 47 × 6.', 'a': '282'},
            {'num': 3, 'topic': 'Fractions',
             'q': 'What is 2/5 of 45?', 'a': '18'},
            {'num': 4, 'topic': 'Addition and Subtraction',
             'q': 'Calculate 8,452 − 3,986.', 'a': '4,466'},
            {'num': 5, 'topic': 'Measurement',
             'q': 'How many cm in 3.7 m?', 'a': '370 cm'},
        ],
    },
}
...
LESSON_DATA[26] = {
    'visuals': {
        # ── CYCLE 1: Short division, no remainder ─────────────────────────────
        'c1_ido1': {
            'slide_type': 'identify_calculate',
            'title': 'I Do — short division',
            'problem': 'A library has 2,184 books that need to be sorted\nequally onto 6 shelves.\nHow many books go on each shelf?',
            'i_know': 'total books = 2,184  ·  shelves = 6',
            'finding': 'books per shelf',
            'attack': '"Equally" and "each shelf" → DIVIDE.',
            'calc_method': 'short_division',
            'top':    '2184',
            'bottom': '6',
            'answer': '364 books per shelf',
            'notes': 'I DO C1 — model short division digit by digit. Emphasise carrying remainders into the next column.',
        },
        'c1_ido2': {
            'slide_type': 'stm_word_problem',
            'title': 'Spot the mistake',
            'problem': '4,356 children are put into 4 equal teams.\nA pupil wrote: 4,356 × 4 = 17,424 children per team.',
            'wrong_working': '4,356 × 4 = 17,424 children per team',
            'error': 'Visualise: large group split into 4 equal teams.\nAnalyse: total=4,356, teams=4.\nAttack: splitting → DIVIDE. 4,356÷4=1,089. Multiply makes it bigger.',
            'notes': 'STM C1 — pupils spot multiplication used instead of division. Use estimate: 4,000 ÷ 4 ≈ 1,000 to show why ×4 is wrong.',
        },
        'c1_wedo': {
            'slide_type': 'identify_calculate',
            'title': 'We Do — together',
            'problem': 'A farmer plants 1,848 seeds equally in 8 rows.\nHow many seeds are in each row?',
            'i_know': 'total seeds = 1,848  ·  rows = 8',
            'finding': 'seeds per row',
            'attack': '"Equally in 8 rows" → DIVIDE.',
            'calc_method': 'short_division',
            'top':    '1848',
            'bottom': '8',
            'answer': '231 seeds per row',
            'notes': 'WE DO C1 — pupils guide teacher through short division. Use estimate 1,800 ÷ 8 ≈ 225 to check.',
        },
        # ── CYCLE 2: Short division, with remainder ───────────────────────────
        'c2_ido1': {
            'slide_type': 'identify_calculate',
            'title': 'I Do — division with remainder',
            'problem': 'Mia has 2,753 stickers.\nShe packs them into books of 9.\nHow many full books does she fill? How many stickers are left over?',
            'i_know': 'total stickers = 2,753  ·  per book = 9',
            'finding': 'full books and remainder',
            'attack': '"Books of 9" means equal groups → DIVIDE.',
            'calc_method': 'short_division',
            'top':    '2753',
            'bottom': '9',
            'answer': '305 full books, 8 left over',
            'notes': 'I DO C2 — model short division with remainder. Discuss what the remainder means in context.',
        },
        'c2_ido2': {
            'slide_type': 'stm_word_problem',
            'title': 'Spot the mistake',
            'problem': '1,958 apples are packed into bags of 6.\nA pupil worked out 1,958 ÷ 6 = 36 remainder 2.',
            'wrong_working': '1,958 ÷ 6 = 36 remainder 2',
            'error': 'Visualise: 1,958 apples in bags of 6.\nAnalyse: 1,958÷6, find bags+remainder.\nAttack: Pupil stopped after first two digits. Full answer: 326 r2.',
            'notes': 'STM C2 — pupils spot that the pupil stopped the short division too early. Reinforce: work through every digit of the dividend.',
        },
        'c2_wedo': {
            'slide_type': 'identify_calculate',
            'title': 'We Do — together',
            'problem': 'A school has 1,473 exercise books.\nThey are shared equally among 5 classes.\nHow many books does each class get? How many are left over?',
            'i_know': 'total = 1,473  ·  classes = 5',
            'finding': 'books per class and remainder',
            'attack': '"Shared equally among 5" → DIVIDE.',
            'calc_method': 'short_division',
            'top':    '1473',
            'bottom': '5',
            'answer': '294 books each, 3 left over',
            'notes': 'WE DO C2 — pupils support each step. Ask: what does the remainder of 3 mean here?',
        },
    },
    'wm': {
        'items': ['🎯', '⭐', '🏆', '🎪', '🌟', '🎨', '🎭'],
        ...
        'qa': [
            {'q': 'What was the 3rd emoji?',              'a': '🏆'},
            {'q': 'Which position was ⭐?',               'a': '2nd'},
            {'q': 'What was the last emoji?',             'a': '🎭'},
            {'q': 'Which emoji was 5th?',                 'a': '🌟'},
            {'q': 'What were the first two emojis?',      'a': '🎯 and ⭐'},
        ],
        'questions': [
            {'q': 'What was the 3rd emoji?',              'a': '🏆'},
            {'q': 'Which position was ⭐?',               'a': '2nd'},
    ...
    'vocab': [
        ['dividend',   'The number being divided — the one you start with.'],
    ...
    'rm': {
        ...
        'questions': [
            {'num': 1, 'topic': 'Place Value',
             'q': 'Round 47,835 to the nearest 1,000.', 'a': '48,000'},
            {'num': 2, 'topic': 'Division',
             'q': 'Calculate 84 ÷ 6.', 'a': '14'},
            {'num': 3, 'topic': 'Fractions',
             'q': 'What is 3/8 of 64?', 'a': '24'},
            {'num': 4, 'topic': 'Measurement',
             'q': 'How many ml in 4.2 litres?', 'a': '4,200 ml'},
            {'num': 5, 'topic': 'Multiplication',
             'q': 'Calculate 237 × 4.', 'a': '948'},
        ],
    },
}
...
LESSON_DATA[27] = {
    'visuals': {
        # ── CYCLE 1: Multiply then add/subtract ──────────────────────────────
        'c1_ido1': {
            'slide_type': 'bar_model',
            'title': 'I Do — two steps',
            'problem': 'Sam has 5 bags of marbles.\nEach bag holds 135 marbles.\nHe gives away 48 marbles to his friends.\nHow many does he have left?',
            'step1': {
                'label': '5 × 135',
                'op': '×',
                'a': '5', 'b': '135', 'result': '675',
                'calc_method': 'mental',
                'calculation': '5 × 135 = 675',
            },
            'step2': {
                'label': '675 − 48',
                'op': '−',
                'a': '675', 'b': '48', 'result': '627',
                'calc_method': 'mental',
                'calculation': '675 − 48 = 627',
            },
            'answer': '627 marbles left',
            'notes': 'I DO C1 — model the bar model diagram first, then show the two-step calculation. Stress: what do I find FIRST?',
        },
        'c1_ido2': {
            'slide_type': 'stm_word_problem',
            'title': 'Spot the mistake',
            'problem': 'A school buys 6 packs of exercise books.\nEach pack has 144 books. It already has 87 books.\nA pupil wrote: 6 + 144 = 150, then 150 + 87 = 237 books.',
            'wrong_working': '6 + 144 = 150\n150 + 87 = 237 books',
            'error': 'Visualise: 6 packs of 144, plus 87 extra.\nAnalyse: step 1=packs total; step 2=add existing.\nAttack: 6 packs of 144 → MULTIPLY: 6×144=864. Then 864+87=951.',
            'notes': 'STM C1 — pupils spot that "6 packs of 144" needed multiplication, not addition.',
        },
        'c1_wedo': {
            'slide_type': 'bar_model',
            'title': 'We Do — together',
            'problem': 'A school buys 3 packs of coloured card.\nEach pack has 245 sheets.\nAfter an art project, 127 sheets are used.\nHow many sheets are left?',
            'step1': {
                'label': '3 × 245',
                'op': '×',
                'a': '3', 'b': '245', 'result': '735',
                'calc_method': 'mental',
                'calculation': '3 × 245 = 735',
            },
            'step2': {
                'label': '735 − 127',
                'op': '−',
                'a': '735', 'b': '127', 'result': '608',
                'calc_method': 'mental',
                'calculation': '735 − 127 = 608',
            },
            'answer': '608 sheets left',
            'notes': 'WE DO C1 — pupils suggest each step. Draw the bar model together first.',
        },
        # ── CYCLE 2: Divide then add/subtract ────────────────────────────────
        'c2_ido1': {
            'slide_type': 'bar_model',
            'title': 'I Do — divide then adjust',
            'problem': 'A farmer picks 1,248 strawberries and packs them\nequally into 8 baskets.\n15 strawberries in one basket are bruised and removed.\nHow many strawberries are in that basket now?',
            'step1': {
                'label': '1,248 ÷ 8',
                'op': '÷',
                'a': '1,248', 'b': '8', 'result': '156',
                'calc_method': 'mental',
                'calculation': '1,248 ÷ 8 = 156',
            },
            'step2': {
                'label': '156 − 15',
                'op': '−',
                'a': '156', 'b': '15', 'result': '141',
                'calc_method': 'mental',
                'calculation': '156 − 15 = 141',
            },
            'answer': '141 strawberries in that basket',
            'notes': 'I DO C2 — model the bar model. Step 1 divides the total equally; step 2 adjusts one share.',
        },
        'c2_ido2': {
            'slide_type': 'stm_word_problem',
            'title': 'Spot the mistake',
            'problem': '935 biscuits are shared equally among 5 classes.\nEach class then eats 18 biscuits at break.\nA pupil wrote: 935 − 5 = 930, then 930 − 18 = 912 biscuits left.',
            'wrong_working': '935 − 5 = 930\n930 − 18 = 912 biscuits left',
            'error': 'Visualise: 935 biscuits split equally, then each group loses 18.\nAnalyse: step 1=per class; step 2=remaining.\nAttack: "share equally" → DIVIDE: 935÷5=187, then 187−18=169.',
            'notes': 'STM C2 — pupils spot that subtraction was used instead of division in step 1.',
        },
        'c2_wedo': {
            'slide_type': 'bar_model',
            'title': 'We Do — together',
            'problem': 'A school has 1,896 library books shared equally\nacross 6 shelves.\nAn author donates 45 more books for one shelf.\nHow many books are on that shelf now?',
            'step1': {
                'label': '1,896 ÷ 6',
                'op': '÷',
                'a': '1,896', 'b': '6', 'result': '316',
                'calc_method': 'mental',
                'calculation': '1,896 ÷ 6 = 316',
            },
            'step2': {
                'label': '316 + 45',
                'op': '+',
                'a': '316', 'b': '45', 'result': '361',
                'calc_method': 'mental',
                'calculation': '316 + 45 = 361',
            },
            'answer': '361 books on that shelf',
            'notes': 'WE DO C2 — pupils guide teacher. Discuss why we divide first before adding the donation.',
        },
    },
    'wm': {
        'items': [4506, 2731, 8048, 1295, 6372, 3814, 9157],
        'category': 'numbers',
        'qa': [
            {'q': 'What was the 4th number?',               'a': '1,295'},
            {'q': 'Which number is largest?',               'a': '9,157'},
            {'q': 'What was the 2nd number?',               'a': '2,731'},
            {'q': 'Which number is closest to 5,000?',      'a': '4,506'},
            {'q': 'What were the last two numbers?',        'a': '3,814 and 9,157'},
        ],
        'questions': [
            {'q': 'What was the 4th number?',               'a': '1,295'},
            {'q': 'Which number is largest?',               'a': '9,157'},
    ...
    'vocab': [
        ...
        ['bar model',   'A diagram that shows the known and unknown parts of a problem.'],
        ['inverse',     'The opposite operation — used to check your answer.'],
        ['estimate',    'A rounded calculation used to check whether your answer makes sense.'],
        ['justify',     'To explain clearly why your answer and method are correct.'],
    ],
    'rm': {
        'day': 4,
        'questions': [
            {'num': 1, 'topic': 'Place Value',
             'q': 'What is 10 times as many as 846?', 'a': '8,460'},
            {'num': 2, 'topic': 'Fractions',
             'q': '3/4 of 120 =', 'a': '90'},
            {'num': 3, 'topic': 'Measurement',
             'q': 'A bag weighs 2 kg 350 g.\nHow many grams is that?', 'a': '2,350 g'},
            {'num': 4, 'topic': 'Multiplication',
             'q': 'Calculate 4 × 326.', 'a': '1,304'},
            {'num': 5, 'topic': 'Division',
             'q': 'Calculate 945 ÷ 5.', 'a': '189'},
        ],
    },
}
