...
5: {
    'visuals': {
        'c1_ido1': {
            ...
            'show_answer': False,
            'answer': '',
            'caption': '236 × 4\n\nOnes first.\nThen tens.\nThen hundreds.\n\nCarry goes ABOVE the next column.',
        ...
        'c1_ido2': {
            ...
            'notes': 'I DO C1 — Extend to 4-digit. Pause on hundreds column: 3×3+1=10, write 0, carry 1.',
        },
        'c2_ido1': {
            ...
            'show_answer': False,
            'answer': '',
            'caption': '3,476 × 8\n\nEstimate first:\n3,500 × 8 = 28,000\n\nEvery column will have a carry.\nWork slowly.',
            'notes': 'I DO C2 — Multiple carries every column. Always look for the carry BEFORE multiplying.',
        },
    },
    'wm': {
    ...
    'vocab': [
        ...
        ('carry',     'A digit written small above the next column when a column total reaches 10 or more.'),
...
6: {
    'visuals': {
        ...
        'c1_ido2': {
            ...
            'show_answer': False,
            'answer': '',
            'caption': '7,543 ÷ 3\n\nCarry the remainder to the next digit.\n\nFinal remainder written as r N.',
            'notes': 'I DO C1 — Show how remainders are carried. Final remainder written as "r N".',
        },
        'c2_ido1': {
