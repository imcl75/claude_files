...
const LESSON_DATA_JS = {
  ...
  5: {
    iCan: [
      ...
      "I can carry correctly and estimate to check my answer is reasonable."
    ],
    lp1: {
  ...
  6: {
    iCan: [
      ...
      "I can carry remainders correctly and interpret any remainder in context."
    ],
    lp1: {
